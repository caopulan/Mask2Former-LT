...
if __name__ == "__main__":
    src_dataset_dir = Path(os.getenv("DETECTRON2_DATASETS", "datasets")) / "coco_stuff_118k"
    tgt_dataset_dir = Path(os.getenv("DETECTRON2_DATASETS", "datasets")) / "coco_stuff_lt_40k"

    lt_names_file = tgt_dataset_dir / "coco-stuff-lt.txt"
    lt_names_list = []
    ...
    train_image_dir = tgt_dataset_dir / "images/train2017"
    train_image_dir.mkdir(parents=True, exist_ok=True)
    train_annotation_dir = tgt_dataset_dir / "annotations/train2017"
    train_annotation_dir.mkdir(parents=True, exist_ok=True)
    for file in tqdm.tqdm(lt_names_list):
        shutil.copy(src_dataset_dir / "images/train2017" / file, train_image_dir / file)
        shutil.copy(src_dataset_dir / "annotations/train2017" / file.replace(".jpg", ".png"),
