...
def register_all_coco_stuff_118k(root):
    root = os.path.join(root, "coco_stuff_118k")
    meta = _get_coco_stuff_118k_meta()
    for name, image_dirname, sem_seg_dirname in [
        ...
        name = f"coco_stuff_118k_sem_seg_{name}"
...
register_all_coco_stuff_118k(_root)
