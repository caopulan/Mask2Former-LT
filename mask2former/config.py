...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.VIT.NUM_HEAD = 12    # 12 for base, 16 for large, 16 for huge
    cfg.MODEL.VIT.MLP_RATIO = 4.0
    cfg.MODEL.VIT.QKV_BIAS = True
    cfg.MODEL.VIT.QK_SCALE = None
    cfg.MODEL.VIT.DROP_RATE = 0.0
    cfg.MODEL.VIT.ATTN_DROP_RATE = 0.0
    cfg.MODEL.VIT.DROP_PATH_RATE = 0.1  # (MAE-pretraining) 0.1 for base, 0.4 for large, 0.5 for huge
    cfg.MODEL.VIT.CLASS_TOKEN = False
    cfg.MODEL.VIT.APE = False
    cfg.MODEL.VIT.INTERVAL = 3
    cfg.MODEL.VIT.PYRAMID_DIM = 256
