...
class MaskFormerHead(nn.Module):
    ...
    def __init__(
        ...
        feature_strides = [v.stride for k, v in input_shape]  # [4, 8, 16, 32]
        feature_channels = [v.channels for k, v in input_shape]  # [256, 512, 1024, 2048]
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        elif cfg.MODEL.MASK_FORMER.TRANSFORMER_IN_FEATURE == "multi_scale_pixel_decoder":  # for mask2former
        ...
        return {
            ...
            "num_classes": cfg.MODEL.SEM_SEG_HEAD.NUM_CLASSES,  # 150 for ade20k, 80 for coco
            "pixel_decoder": build_pixel_decoder(cfg, input_shape),  # pixel decoder
